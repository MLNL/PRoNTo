...
%      PRT_UI_RESULTS_HELP, by itself, creates a new PRT_UI_RESULTS_HELP or raises the existing
%      singleton*.
%
%      H = PRT_UI_RESULTS_HELP returns the handle to a new PRT_UI_RESULTS_HELP or the handle to
%      the existing singleton*.
%
%      PRT_UI_RESULTS_HELP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PRT_UI_RESULTS_HELP.M with the given input arguments.
%
%      PRT_UI_RESULTS_HELP('Property','Value',...) creates a new PRT_UI_RESULTS_HELP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before prt_ui_results_help_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to prt_ui_results_help_OpeningFcn via varargin.
%
