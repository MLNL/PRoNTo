...
mod_n={handles.PRT.masks(handles.indmod).mod_name}; %only one modality
...
if length(mod_n)==1 && (isempty(handles.PRT.group(1).subject(1).modality(handles.indmod).design) ...
        || ~isstruct(handles.PRT.group(1).subject(1).modality(handles.indmod).design))
