...
% *in.fa_detrend: whether to detrend the file array 
%
...
% Initialize the file arrays and the kernel parameters 
...
%Apply the detrending and normalisation at the kernel level if
%user-specified
%--------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
outfile = in.fname;
disp('Saving data preparation to: PRT.mat.......>>')
