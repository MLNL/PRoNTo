...
\begin{itemize}
	...
	\item In the `Data operations' box, select the `Mean centre features using training data' and `Normalize samples' options. Then, the `Specify model' window should look similar to the one in Figure \ref{fig:data_example3_gui_model_specify_new_final};
