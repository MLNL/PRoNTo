...
\textit{Regression targets (trials)}
Enter one regression target per trial.
...
\textit{Covariates}
Select a matrix/vector containing details of your covariates (i.e. any other data/information you would like to include in your design). If you enter a vector instead of a matrix, the entries of the vector will be repeated to create a matrix with the dimensions: number of scans x number of covariates (or vector entries.
...
\subsubsection{Regression targets (subjects)}
