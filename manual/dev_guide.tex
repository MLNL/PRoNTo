...
\begin{figure}[!htbp]
  \begin{center}
      \includegraphics[height=2.2in]{images/code.png}
...
In addition, the outputs of the function need to have the following format, so that they can be read by the wrapper and translated back to the PRoNTo framework (all fields are mandatory except where otherwise stated):
