...
%\end{figure}
   ...
   \item It is important to optimize the hyperparameter when we try to remove confounds. Results without hyperparameter optimization will be slightly worse than results with this optimization. 
