...
of the decision function's weight map, unless they have perfectly null contribution (as might happen from L1-MKL modelling}. 
...
a dialogue opens that allows you to select an anatomical images {\tt .img} file that.
was co-registered with the data images.
...
The bar plot displays the third column of the table, i.e. the contribution of each ROI or modality to the decision function. The x-axis represents the index of the ROI in the table (i.e. first column of the table), in the selected fold, while the y-axis displays the contribution of each region/modality. The bar graph provides insights on how sparse the region/modality contributions are.
