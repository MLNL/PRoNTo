...
fprintf(fp,'%s\n%s\n%s\n%s\n%s\n%s\n%s\n',...
    ...
    'pdftitle={PRoNTo Manual},','pdfauthor={The PRoNTo Team},',...
...
fprintf(fp,'\\title{\\huge{PRoNTo Manual}}\n');
fprintf(fp,'\\author{The PRoNTo Team}\n');
...
% >> >> spm_jobman('initcfg');
% >> >> spm_latex_cfg
% puis tu compiles le LaTeX:
% pdflatex manual.tex
% bibtex manual
% pdflatex manual.tex jusqu'a convergence.
% 
% Bon weekend,
% Guillaume.
