function K = covLINsimplekcell(hyp, A, B, i)

% Linear covariance function without any hyps. The covariance
...
% Changed by Onan Guren so that there are no hyps
% Finalised by Anil Rao
