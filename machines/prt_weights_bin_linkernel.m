function weights = prt_weights_bin_linkernel (PRT,model)
% Run function to compute weights for linear kernel binary classifier
% FORMAT weights = prt_weights_bin_linkernel (PRT,model)
% Inputs:
...
% $Id: prt_weitghts_bin_linkernel.m $
