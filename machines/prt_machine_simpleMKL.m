function output = prt_machine_simpleMKL(d,args)
...
if SANITYCHECK==true
    ...
    if ~isnumeric(args)
        error('prt_machine_simpleMKL:MKLargsNotNumber',['Error: L1_MKL'...
    ...
    nC=numel(uTL);
    if nC>2
        error('prt_machine_simpleMKL:problemNotBinary',['Error:'...
