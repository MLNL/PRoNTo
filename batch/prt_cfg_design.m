...
scans.tag     = 'scans';
scans.name    = 'Files';
scans.help    = {['Select files for this modality. They must '...
...
subjects.name    = 'Files';
subjects.help    = {['Select files for this modality. They must '...
    'all have the same image dimensions, orientation, '...
...
images.help   = {['Depending on the type of data at hand, you may have many samples '...
    'per subject, such as a fMRI time series, or you may have many '...
    'subjects with only one or a small number of samples per subject, '...
    'such as PET images. ',...
    'Select this option if you have many subjects per modality to spatially ',...
    'normalise, but there is only one sample for '...
    ...
    '''PRT.mat'' but ''select by samples'' is optimised for modalities '...
    'with no design.']};
...
% ---------------------------------------------------------------------
cov_trial         = cfg_files;
cov_trial.tag     = 'cov_trial';
cov_trial.name    = 'Covariates';
cov_trial.help    = {['Select a .mat file containing '...
    'your covariates (i.e. any other data/information '...
    'you would like to include in your design). This file '...
    'should contain a variable ''R'' with a matrix of '...
    'covariates. Its size should be #samples x #covariates.']};
cov_trial.val{1}  = {''};
...
conditions.help    = {['Specify conditions. This option is not available for MEEG. '...
...
new_design.help    = {'Specify design: samples (data), onsets and durations.'};
...
no_design.help    = {['Do not specify design. This option can be used '...
    ...
    'have an experimental design. Possibility to specify one regression target and/or covariate'...
...
subjs.tag     = 'subjs';
subjs.name    = 'Subjects';
subjs.help    = {'Add subjects/samples.'};
...
select.help   = {...
    ['Depending on the type of data at hand, you may have many samples '...
    'per subject, such as a fMRI time series, or you may have many '...
    'subjects with only one sample per subject '...
    ', such as PET images. If you have many samples per subject select the '...
    'option ''subjects''. If you have one sample for many subjects select '...
    'the option ''samples''.']};
