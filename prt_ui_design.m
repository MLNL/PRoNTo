...
%      PRT_UI_DESIGN, by itself, creates a new PRT_UI_DESIGN or raises the existing
%      singleton*.
%
%      H = PRT_UI_DESIGN returns the handle to a new PRT_UI_DESIGN or the handle to
...
%      applied to the GUI before prt_ui_design_OpeningFcn gets called.  An
